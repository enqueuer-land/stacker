<template>
    <b-container id="result-body" style="overflow-y: scroll; width: 100%; height: 100%">
        <b-row no-gutters v-for="test in filteredFlattenTests" :key="test.id" class="px-2 pb-1 collapsed"
            ...
            <b-breadcrumb class="m-0 pb-0 pt-1 pl-3 pr-2 breadcrumb carabina-text" style="font-size: 14px"
            ...
            <b-col cols class="align-self-center px-2">
                ...
                <b-collapse :id="test.id" v-if="test.description" class="p-0 m-0 pt-1 pl-1 carabina-text" style="font-size: 14px">
                    {{test.description}}
                </b-collapse>
            </b-col>
