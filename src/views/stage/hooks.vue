            ...
            eventHasAttribute: function () {
                return function (name) {
                    ...
                    if (componentEvent) {
                        ...
                        const assertionsCondition = componentEvent.assertions && componentEvent.assertions.length > 0 &&
                            componentEvent.assertions
                                .some(assertion => Object.keys(assertion)
                                    .some(key => key !== 'id' && assertion[key].length > 0));
